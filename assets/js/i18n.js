/* ═══════════════════════════════════════════════════════════════
   Association statAfrikR — i18n.js v3
...
const T = {
'nav.association':  {fr:'Association', en:'Association'},
...
'hero.stat2l': {fr:'Fonctions · v0.2.0 sur le CRAN', en:'Functions · v0.2.0 on CRAN'},
...
'label.association':  {fr:'L\'Association', en:'The Association'},
...
'title.association':   {fr:'Vision, Mission & Valeurs', en:'Vision, Mission & Values'},
...
'title.don':         {fr:'Faire un don à l\'Association statAfrikR', en:'Donate to the Association statAfrikR'},
'title.partenariat': {fr:"Le premier INS qui signe devient le Partenaire Fondateur", en:'The first NSO to sign becomes the Founding Partner'},
...
'title.fonds':       {fr:'Pourquoi une association loi 1901 ?', en:'Why an non-profit association?'},
...
'title.fonctions':   {fr:'Les fonctions de statAfrikR v0.2.0', en:'The statAfrikR v0.2.0 functions'},
...
'title.jalons':      {fr:'Jalons clés', en:'Key milestones'},
...
'title.3piliers':    {fr:'Sources de ressources de l\'Association', en:'Association funding sources'},
...
'title.partenariat.cta':{fr:"Le point focal national de l'Association dans votre INS", en:'The Association national focal point in your NSO'},
...
'page.association.h1':  {fr:'L\'Association statAfrikR', en:'The Association statAfrikR'},
'page.association.lead':{fr:'Association panafricaine open source pour la statistique publique africaine', en:'Pan-African open sourcette association for African public statistics'},
'page.gouv.h1':       {fr:'Gouvernance de l\'Association', en:'Association Governance'},
'page.gouv.lead':     {fr:'Modèle DuckDB Association adapté au contexte panafricain — Collégiale, neutre, anti-capture', en:'DuckDB Association model adapted to the pan-African context — Collegial, neutral, anti-capture'},
'page.pkg.h1':        {fr:'Le package statAfrikR', en:'The statAfrikR package'},
'page.pkg.lead':      {fr:'Premier package R open source dédié aux INS africains — plus de 100 fonctions · 5 modules · 707+ tests', en:'First open source R package for African NSOs — 100+ functions · 5 modules · 707+ tests'},
...
'page.rm.lead':       {fr:'Du CRAN à la validation institutionnelle — 3 phases, de v0.2.0 à v1.0.0', en:'From CRAN to institutional validation — 3 phases, from v0.2.0 to v1.0.0'},
...
'page.don.h1':        {fr:'Soutenir l\'Association statAfrikR', en:'Support the Association statAfrikR'},
...
'page.part.h1':       {fr:"Le premier INS qui signe devient le Partenaire Fondateur", en:'The first NSO to sign becomes the Founding Partner'},
'page.part.lead':     {fr:"Votre INS accueille le point focal national de l'Association statAfrikR en Afrique", en:'Your NSO hosts the Association statAfrikR national focal point in Africa'},
...
'bc.association':   {fr:'L\'Association', en:'The Association'},
...
'rm.p1.title':{fr:'Association', en:'Association'},
...
'voir.association':  {fr:'Voir la page complète Association →', en:'View the full Association page →'},
...
'footer.legal':{fr:'© 2026 Association statAfrikR · Association loi 1901 · Siège : 17 rue du Chêne Tordu, 77500 Chelles (France) · GPL-3', en:'© 2026 Association statAfrikR · Non-profit association · Registered office: 17 rue du Chêne Tordu, 77500 Chelles (France) · GPL-3'},
};
